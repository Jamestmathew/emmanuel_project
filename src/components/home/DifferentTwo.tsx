...
export default function DifferentTwo() {
  return (
            ...
            <div className="difference-two__inner-content">
              <div className="difference-two__tab">
                <div className="difference-two__tab-btns">
                  <button className="difference-two__tab-btn active" data-target="#mission" aria-label="mission" title="mission">Our Mission</button>
                  <button className="difference-two__tab-btn" data-target="#vision" aria-label="vision" title="vision">Our Vision</button>
                  <button className="difference-two__tab-btn" data-target="#excellence" aria-label="excellence" title="excellence">Excellence</button>
                </div>
                <div className="difference-two__tab-content">
                  <div className="difference-two__content-single" id="mission">
                    <ul>
                      <li><i className="fa-solid fa-check" />We help companies develop
                        powerful corporate social
                      </li>
                      <li><i className="fa-solid fa-check" />Helped fund 3,265 Project
                        powerful corporate poor
                      </li>
                      <li><i className="fa-solid fa-check" />Dedicated Tech Services</li>
                    </ul>
                  </div>
